...
public class Sprite {
	...
	public static Sprite balloon = new Sprite(DEFAULT_SIZE, 9, 0, SpriteSheet.tiles, 14, 14);
	public static Sprite oneal = new Sprite(DEFAULT_SIZE, 12, 0, SpriteSheet.tiles, 14, 14);
	/*
	|--------------------------------------------------------------------------
	| Bomber Sprites
	|--------------------------------------------------------------------------
